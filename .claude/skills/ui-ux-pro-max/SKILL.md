...
This skill is installed into this repository at `.claude/skills/ui-ux-pro-max/`. All paths below are relative to the project root, which is Claude Code's working directory — run them from there:
